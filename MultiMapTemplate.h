...
#define MapDef(Name,Hash,Cmp,Alloc,Free)\
	static void MapRESERVED__MapRehash_##Name(Map_##Name*MapRESERVED__Map,size_t MapRESERVED__NewBucketsSize){\
		...
		for(size_t MapRESERVED__Idx=0;MapRESERVED__Idx!=MapRESERVED__Map->MapBucketsSize;++MapRESERVED__Idx){\
			MapEntry_##Name*MapRESERVED__Entry=MapRESERVED__Map->Buckets[MapRESERVED__Idx];\
		...
		Free(MapRESERVED__Map->Buckets,MapRESERVED__Map);\
		MapRESERVED__Map->Buckets=MapRESERVED__NewBuckets;\
	...
	MapEntry_##Name**MapFind_##Name(Map_##Name*MapRESERVED__Map,MapKey_##Name MapRESERVED__Key){\
		...
		if(Cmp(MapRESERVED__Key,MapRESERVED__Entry->MapKey,MapRESERVED__Map)){\
			return MapRESERVED__Map->Buckets+MapRESERVED__Idx;}\
		for(;;){\
			MapEntry_##Name*MapRESERVED__Next=MapRESERVED__Entry->MapNext;\
	...
	MapEntry_##Name**MapAdd_##Name(Map_##Name*MapRESERVED__Map,MapKey_##Name MapRESERVED__Key){\
		...
		if(!MapRESERVED__Map->MapBucketsSize){\
			if(sizeof(MapEntry_##Name*)>SIZE_MAX>>3||!(MapRESERVED__Map->Buckets=Alloc(sizeof(MapEntry_##Name*)<<3),MapRESERVED__Map)){\
			...
			MapRESERVED__Map->Buckets[MapRESERVED__Idx]=MapRESERVED__Entry;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+1&7]=0;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+2&7]=0;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+3&7]=0;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+4&7]=0;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+5&7]=0;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+6&7]=0;\
			MapRESERVED__Map->Buckets[MapRESERVED__Idx+7&7]=0;\
			return MapRESERVED__Map->Buckets+MapRESERVED__Idx;}\
		...
		MapRESERVED__Entry->MapNext=MapRESERVED__Map->Buckets[MapRESERVED__Idx];\
		MapRESERVED__Map->Buckets[MapRESERVED__Idx]=MapRESERVED__Entry;\
		return MapRESERVED__Map->Buckets+MapRESERVED__Idx;}\
	MapEntry_##Name**MapLocate_##Name(Map_##Name*MapRESERVED__Map,MapEntry_##Name*MapRESERVED__Entry){\
		...
		MapEntry_##Name*MapRESERVED__Prev=MapRESERVED__Map->Buckets[MapRESERVED__Idx];\
